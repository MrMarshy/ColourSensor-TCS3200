...
//
void i2c_set_tx(I2C_MemMapPtr p)     {p->C1 |= I2C_C1_TX_MASK;}
void i2c_set_rx(I2C_MemMapPtr p)     {p->C1 &= ~I2C_C1_TX_MASK;}
void i2c_set_slave(I2C_MemMapPtr p)  {p->C1 &= ~I2C_C1_MST_MASK;}
void i2c_set_master(I2C_MemMapPtr p) {p->C1 |=  I2C_C1_MST_MASK;}
void i2c_give_nack(I2C_MemMapPtr p)  {p->C1 |= I2C_C1_TXAK_MASK;}
void i2c_give_ack(I2C_MemMapPtr p)   {p->C1 &= ~I2C_C1_TXAK_MASK;}
void i2c_repeated_start(I2C_MemMapPtr p){p->C1     |= I2C_C1_RSTA_MASK;}
uint8_t i2c_read(I2C_MemMapPtr p)    {return p->D;}
...
static int16_t _read_reg14(int reg)
{
